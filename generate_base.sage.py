...
def M_to_E(P):
    ...
    X = _sage_const_2 *s / (_sage_const_1 +s**_sage_const_2 )
    Y = (_sage_const_1 -(s**_sage_const_2 )) / t # This is phi_a(s, t) page 7
    if maybe(): X,Y = -X,-Y
    if maybe(): X,Y = Y,-X
    # OK, have point in ed
    return X,Y
